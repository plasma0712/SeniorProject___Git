...
public class MonsterSelectListManager : Singleton<MonsterSelectListManager>
{
    ...
    public void Init()
    {
        ...
        else //(ClearStageNumber.Instance.StageNumber>0)
        {
            ...
            ContentRectTrans.sizeDelta = new Vector2(ContentRectTrans.sizeDelta.x, 230 * XMLMonster.Instance.Monsters.Count-2);
        }
    }
}
